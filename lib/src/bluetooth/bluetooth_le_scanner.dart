...
abstract class BluetoothLeScanner {
  ...
  static const String EXTRA_LIST_SCAN_RESULT = "android.bluetooth.le.extra.LIST_SCAN_RESULT";
  ...
  static const String EXTRA_ERROR_CODE = "android.bluetooth.le.extra.ERROR_CODE";
  ...
  static const String EXTRA_CALLBACK_TYPE = "android.bluetooth.le.extra.CALLBACK_TYPE";
}
